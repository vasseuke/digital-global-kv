...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-article-text.js
  var import_article_text_exports = {};
  __export(import_article_text_exports, {
    default: () => import_article_text_default
  });
  ...
  var import_article_text_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_article_text_exports);
})();
