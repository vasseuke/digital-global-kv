...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-card-grid-listing.js
  var import_card_grid_listing_exports = {};
  __export(import_card_grid_listing_exports, {
    default: () => import_card_grid_listing_default
  });
  ...
  var import_card_grid_listing_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_card_grid_listing_exports);
})();
