...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-contact-form.js
  var import_contact_form_exports = {};
  __export(import_contact_form_exports, {
    default: () => import_contact_form_default
  });
  ...
  function parse2(element, { document: document2 }) {
    ...
    if (cells.length === 0) {
      const fallback = Array.from(element.querySelectorAll(".text, .cont-text")).flatMap((t) => Array.from(t.children));
  ...
  var import_contact_form_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_contact_form_exports);
})();
