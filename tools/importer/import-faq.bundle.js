...
var CustomImportScript = (() => {
  ...
  function parse(element, { document: document2 }) {
    ...
    const container = element.closest(".faq_width, main.page-main, section:not(.expander), body") || element.parentElement || element;
    let expanders = Array.from(container.querySelectorAll("section.expander")).filter((ex) => {
    ...
    const buildQuestion = (ex) => {
      ...
      if (h && h.textContent.trim()) {
        const el = document2.createElement("h3");
